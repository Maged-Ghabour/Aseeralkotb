<div>
    <nav class="navbar navbar-expand-lg bg-dark navbar-dark">
        <div class="container-fluid">
          <a class="navbar-brand" href="{{route('books.index')}}">مكتبــــتي</a>
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            @if (Auth::user()->is_admin==1)
              ...
              <li class="nav-item">
                <a class="nav-link" href="{{route('authors.create')}}">@lang("site.addAuthor")</a>
              </li>
            @endif
              ...
              <li class="nav-item">
                <a class="nav-link" href="{{route('authors.index')}}">@lang("site.authors")</a>
              </li>
